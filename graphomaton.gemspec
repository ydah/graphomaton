...
Gem::Specification.new do |spec|
  ...
  spec.description = 'Graphomaton is a lightweight Ruby library for creating and visualizing finite state machines. It supports multiple output formats including SVG, PNG, PDF, Mermaid.js, GraphViz DOT, and PlantUML, making it easy to generate professional automaton diagrams.'
